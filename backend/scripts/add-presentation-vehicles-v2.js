...
async function addPresentationVehicles() {
  try {
    console.log('🚗 Adding vehicles for presentation...');
    ...
    // Add unique vehicles for presentation
    const vehicles = [
      {
        hostId: users[0].id,
        make: 'BMW',
      ...
      },
      {
        ...
        features: ['Leather Seats', 'Navigation', 'Backup Camera', 'Premium Sound'],
        fuelType: 'petrol',
        transmission: 'automatic',
        seats: 5,
        mileage: 18000,
      ...
      },
      {
        ...
        city: 'Durban',
        status: 'approved',
        title: '2023 Hyundai i20 Compact Car',
      ...
      },
      {
        ...
        city: 'Port Elizabeth',
        status: 'approved',
        title: '2020 Nissan Navara Adventure Truck',
      ...
      },
      {
        ...
        features: ['Air Conditioning', 'Bluetooth', 'USB Port', 'Sunroof'],
        fuelType: 'petrol',
        transmission: 'automatic',
        seats: 5,
        mileage: 15000,
      ...
      },
      {
        ...
        city: 'Johannesburg',
        status: 'approved',
        title: '2019 Mercedes-Benz C-Class Luxury',
        description: 'Elegant Mercedes-Benz C-Class with premium features and superior comfort.',
        location: '555 Rosebank, Johannesburg',
      ...
      },
      {
        ...
        city: 'Durban',
        status: 'approved',
        title: '2021 Ford Ranger Work Truck',
        description: 'Rugged Ford Ranger perfect for work projects and outdoor adventures.',
        location: '888 Gateway, Durban',
        features: ['4x4', 'Air Conditioning', 'Bluetooth', 'Towing Package'],
        fuelType: 'diesel',
        transmission: 'manual',
        seats: 5,
    ...
    for (const vehicleData of vehicles) {
      try {
        ...
        console.log(`✅ Created: ${listing.title} - R${listing.pricePerDay}/day`);
      } catch (error) {
        console.log(`⚠️  Error creating ${vehicleData.title}: ${error.message}`);
      }
    }
    ...
    // Show all approved vehicles
    const allListings = await Listing.findAll({ where: { status: 'approved' } });
    console.log(`\n🚗 Total approved vehicles: ${allListings.length}`);
...
module.exports = { addPresentationVehicles };
